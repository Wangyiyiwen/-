...
export function SimpleLineChart({ data, width = 400, height = 200 }: SimpleLineChartProps) {
          ...
          .map((point, index) => (
            <g key={index}>
              <line
                ...
                strokeWidth="1"
              />
              <text x={point.x} y={height - padding + 18} textAnchor="middle" fontSize="10" fill="#64748b">
                {point.time}
              </text>
            </g>
          ))}
